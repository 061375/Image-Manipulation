...
export class ImageData { 
	 ...
	 * @returns 
	 */
	canvas($t:any,w:string,h:string,ctxObj:any) {
		let cid:number = Public.CIDS;
		// create canvas
 ...
 */
	public loopPixels(p: any, params): Promise<unknown> {
	 ...
	 * @returns {Promise}
	 */
	public loopPixels2({ pdata }: {
			pdata: {
				buffer: Uint8ClampedArray; 
				canvas: { width: number; height: number; }; 
				cb_params: any;
			};
		}, step:number = 1): Promise<unknown> {
